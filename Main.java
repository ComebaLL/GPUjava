...
public class Main {
 public static class GPU {
    ...
    public static void main(String[] args) {
        GPU gpu_test = new GPU();
        GPU[] gpu_test1 = new GPU[1];

        gpu_test1[0].set_price(11000);
        gpu_test1[0].set_GPU("4080");
        gpu_test1[0].set_memorySize(320);
        gpu_test1[0].set_memoryType("GDDR6");
        gpu_test1[0].set_producer("NVIDIA");
        gpu_test1[0].set_connectionType("HDMI,DisplayPort x4");

        gpu_test.set_price(9000);
        gpu_test.set_GPU("3080");
        gpu_test.set_connectionType("HDMI, DisplayPort x3");
        gpu_test.set_memorySize(320);
        gpu_test.set_producer("NVIDIA");
        gpu_test.set_memoryType("GDDR6x");
        gpu_test.to_string();
        gpu_test.write_in_file();
